...
def output_predict_result(output, name, dir="./output_test/"):
    ...
    a.to_csv("output_test3/" + name + '.csv')
...
test_dataset = Testset(label_name="Color", data_dir="../data/test", transform=transforms.Compose([
...
backbone_exposure = models.resnet152(pretrained=True)
model_exposure = ResNet152(backbone_exposure, num_classes=15)

checkpoint_exposure = torch.load("saved-models/ResNet152-Exposure/epoch_98.pt")
